...
**Titre** — court et explicite, au format `[type(scope)]: message`  
**Description** — explique le *pourquoi* du changement  
**Impact** — détaille l’effet attendu (bug résolu, feature ajoutée, perf améliorée, etc.)
